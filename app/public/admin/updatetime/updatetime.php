...
<head>
    ...
    <title>Editör Düzenleme Zamanı</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <h1 class="h3 mb-4 text-gray-800">Editör Düzenleme Zamanı Güncelle</h1>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-10">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Editör Düzenleme Zamanı Formu</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                                ...
                                                <div class="form-group d-flex justify-content-center">
                                                    <div class="col-10 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control" name="time"
                                                            placeholder="Editör Güncelleme Zamanı" value="<?echo $data[1]?>"> 
                                                    </div>
                                                </div>
                                                <div class="form-group d-flex justify-content-center">
