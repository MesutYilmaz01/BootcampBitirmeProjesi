                            ...
                            <div class="col-8 mt-3">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body mb-2">
                                        <div>
                                            <img src="https://i.ytimg.com/vi/4T5IUk_e9uQ/maxresdefault.jpg" width="650px"/>
                                        </div>
                                        <div class="mt-3 text-gray-900">
                                            ...
                                            <div class="mt-3">
                                                <h4 class="text-gray-900">Kategoriler</h4>
                                                <div class="text-lg text-gray-600">Global, Spor</div>
                                            </div>
                                            <div class="mt-3">
                                                <a href="updatenew.php?id=1" class="btn btn-success">Güncelle</a>
