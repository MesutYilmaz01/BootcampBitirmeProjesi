...
{
    $message = "Onaylama işlemi başarıyla gerçekleşti.";
}
header('refresh:3;url=/admin/comments/comments'); 
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-10">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Yorum Onaylama Formu</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="alert alert-warning" role="alert">
                                                <? echo $message?></br>
                                                Yorumlar sayfasına yönlendiriliyorsunuz...
                                            </div>
                                        </div>
                                    </div>
                                </div>
